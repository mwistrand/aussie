...
class PassThroughIntegrationTest {
    ...
    class BasicPassThroughTests {
        ...
        void shouldPassThroughDeleteRequest() {
            backendServer.stubFor(delete(urlEqualTo("/api/users/1"))
                .willReturn(aResponse()
                    .withStatus(204)));
            ...
            given()
                .when()
                .delete("/user-service/api/users/1")
                .then()
                .statusCode(204);
    ...
    class ServiceNotFoundTests {
        ...
        void shouldNotConflictWithGatewayPath() {
            given()
                ...
                .then()
                .statusCode(404)
                .body(containsString("No route found"));
        }
    }
    ...
    class BackendErrorTests {
        ...
        void shouldForward404FromBackend() {
            ...
            given()
                .when()
                .get("/missing-service/api/missing")
                .then()
                .statusCode(404);
        }
    ...
    class AccessControlTests {
        ...
        void shouldAllowPassThroughWithAccessConfigFromAuthorizedIp() {
            ...
            given()
                .header("X-Forwarded-For", "172.16.1.1")
                .when()
                .get("/restricted-service/api/secret")
                .then()
                .statusCode(200)
    ...
    class PassThroughWithEndpointsTests {
        ...
        void shouldPassThroughUnregisteredPaths() {
            ...
            var endpoint = new EndpointConfig("/api/health", Set.of("GET"), EndpointVisibility.PUBLIC, Optional.empty());
