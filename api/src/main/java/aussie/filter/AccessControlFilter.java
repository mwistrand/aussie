...
import aussie.access.AccessControlEvaluator;
import aussie.access.SourceIdentifierExtractor;
...
public class AccessControlFilter implements ContainerRequestFilter {
    ...
    private void handlePassThroughRequest(ContainerRequestContext requestContext, String path, String method) {
        ...
        var syntheticRoute = new RouteMatch(service, syntheticEndpoint, remainingPath, java.util.Map.of());
