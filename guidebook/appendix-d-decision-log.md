...
- This creates friction for internal-only deployments where all endpoints should be public. The administrator must set `publicDefaultVisibilityEnabled = true` to allow public defaults. This is deliberate, as the friction ensures the decision is conscious.
